...
export function DeployButton() {
  return (
    ...
    >
      <Button
        className="flex items-center gap-2 bg-primary text-primary-foreground hover:bg-secondary hover:text-secondary-foreground transition-colors px-3 py-1.5 rounded-md shadow"
        size="sm"
      >
        <svg
          className="h-3 w-3"
